                ...
                <Tabs value="detail">
                    <TabPane :label="L('UserDetails')" name="detail">
                        <FormItem :label="L('CountryName')" prop="countryName">
                            <countrylist v-model="customer.countryCode">
                            </countrylist>
                        </FormItem>
...
<script lang="ts">
    ...
    export default class CreateCustomer extends AbpBase{
        ...
        customerRule={
            ...
            customerCode:[{required:true,message:this.L('FieldIsRequired',undefined,this.L('CustomerCode')),trigger: 'blur'}],
            customerName:[{required:true,message:this.L('FieldIsRequired',undefined,this.L('CustomerName')),trigger: 'blur'}],
            address:[{required:true,message:this.L('FieldIsRequired',undefined,this.L('Address')),trigger: 'blur'}],
            phone:[{required:true,validator:Validate.TelCheck,trigger: 'blur'}],
            syncId:[{required:true,message:this.L('FieldIsRequired',undefined,this.L('SyncId')),trigger: 'blur'}],

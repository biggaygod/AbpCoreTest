    ...
    <div>
        ...
        >
            <Form ref="countryForm"  label-position="top" :rules="countryRule" :model="country">
                <Tabs value="detail">
                    <TabPane :label="L('CountryDetails')" name="detail">
                        ...
                        <FormItem :label="L('ChineseName')" prop="chineseName">
                            <Input v-model="country.chineseName" :maxlength="32"></Input>
                        </FormItem>
                        <FormItem :label="L('EnglishName')" prop="englishName">
                            <Input v-model="country.englishName" :maxlength="32"></Input>
                        </FormItem>
                        <FormItem>
...
<script lang="ts">
    ...
    @Component
    export default class EditCountry extends AbpBase{
        ...
        visibleChange(value:boolean){
            if(!value){
                ...
                this.country=Util.extend(true,{},this.$store.state.country.editCountry);
            }
        }
        countryRule={

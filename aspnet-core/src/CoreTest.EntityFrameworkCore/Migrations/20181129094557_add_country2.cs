...
{
    public partial class add_country2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_C_Country", x => new { x.CountryId, x.CountryCode });
                    table.UniqueConstraint("AK_C_Country_CountryCode_CountryId", x => new { x.CountryCode, x.CountryId });
                });
        }
